package com.ing.tech.cvService.repositories;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ing.tech.cvService.config.BackupConfig;
import com.ing.tech.cvService.data.CurriculumVitae;
import com.ing.tech.cvService.exceptions.CVNotFoundException;
import com.ing.tech.cvService.exceptions.EmailAlreadyExistsException;
import com.ing.tech.cvService.exceptions.FileAccessException;
...
public class CVDatabase {
    ...
    public CVDatabase(BackupConfig backupConfig) {
        String fileName = backupConfig.getFilename();
